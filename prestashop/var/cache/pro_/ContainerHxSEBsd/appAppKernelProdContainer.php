    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'modules_translation_paths' => [
                ...
                60 => (\dirname(__DIR__, 4).'/modules/productcomments/translations'),
                61 => (\dirname(__DIR__, 4).'/modules/ps_shoppingcart/translations'),
                62 => (\dirname(__DIR__, 4).'/modules/ps_specials/translations'),
                63 => (\dirname(__DIR__, 4).'/modules/ps_bestsellers/translations'),
                64 => (\dirname(__DIR__, 4).'/modules/ps_newproducts/translations'),
                65 => (\dirname(__DIR__, 4).'/modules/ps_linklist/translations'),
                66 => (\dirname(__DIR__, 4).'/modules/ps_customeraccountlinks/translations'),
            ],
