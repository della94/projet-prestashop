...
class appAppKernelProdContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'prestigeshop', 'user' => 'root', 'password' => '', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('saYjqgjJEYpiRWyw7gV4qHThJODbwE2Aaphw9PtHEX942C1EGIeZx5FC6swsfFn0'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                22 => 'gridhtml',
                23 => 'gsitemap',
                24 => 'klaviyopsautomation',
                25 => 'mbeshipping',
                26 => 'pagesnotfound',
                27 => 'psxmarketingwithgoogle',
                28 => 'ps_accounts',
                29 => 'ps_eventbus',
                30 => 'ps_brandlist',
            ...
            'modules_translation_paths' => [
                ...
                15 => (\dirname(__DIR__, 4).'/modules/dashactivity/translations'),
                16 => (\dirname(__DIR__, 4).'/modules/dashgoals/translations'),
                17 => (\dirname(__DIR__, 4).'/modules/dashproducts/translations'),
                18 => (\dirname(__DIR__, 4).'/modules/dashtrends/translations'),
                19 => (\dirname(__DIR__, 4).'/modules/gamification/translations'),
                20 => (\dirname(__DIR__, 4).'/modules/gridhtml/translations'),
                21 => (\dirname(__DIR__, 4).'/modules/gsitemap/translations'),
                22 => (\dirname(__DIR__, 4).'/modules/mbeshipping/translations'),
                23 => (\dirname(__DIR__, 4).'/modules/pagesnotfound/translations'),
                24 => (\dirname(__DIR__, 4).'/modules/psxmarketingwithgoogle/translations'),
                ...
                31 => (\dirname(__DIR__, 4).'/modules/ps_edition_basic/translations'),
                32 => (\dirname(__DIR__, 4).'/modules/ps_emailalerts/translations'),
                33 => (\dirname(__DIR__, 4).'/modules/ps_facebook/translations'),
                ...
                58 => (\dirname(__DIR__, 4).'/modules/blockwishlist/translations'),
                59 => (\dirname(__DIR__, 4).'/modules/productcomments/translations'),
                60 => (\dirname(__DIR__, 4).'/modules/ps_shoppingcart/translations'),
                61 => (\dirname(__DIR__, 4).'/modules/ps_specials/translations'),
                62 => (\dirname(__DIR__, 4).'/modules/ps_bestsellers/translations'),
                63 => (\dirname(__DIR__, 4).'/modules/ps_newproducts/translations'),
                64 => (\dirname(__DIR__, 4).'/modules/ps_linklist/translations'),
                65 => (\dirname(__DIR__, 4).'/modules/ps_customeraccountlinks/translations'),
            ...
            'kernel.secret' => 'saYjqgjJEYpiRWyw7gV4qHThJODbwE2Aaphw9PtHEX942C1EGIeZx5FC6swsfFn0',
