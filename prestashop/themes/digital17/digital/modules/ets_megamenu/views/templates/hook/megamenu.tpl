...
{if $menusHTML}
    <div class="ets_mm_megamenu ets_animated 
        {if $page.page_name != 'index' && (isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT == 'LayoutHome1' || $tc_config.YBC_TC_LAYOUT == 'LayoutHome3' || $tc_config.YBC_TC_LAYOUT == 'LayoutHome6'))}close_menu{/if}
