...
{if $widgets}
    ...
    {elseif $widget_hook == "display-nav"}
        <div class="header_user_info blockuserinfo">
            <span class="header_user_info_toogle hidden-md-up toogle_custom" id="btn_quick_link">
                <i class="fa fa-info-circle" aria-hidden="true"></i>{l s='Info' d='Modules.widgets.Shop'}
            </span>
            <ul class="header_user_info_toogle_content toogle_content_custom ybc-widget-{$widget_hook|escape:'html':'UTF-8'}">
                {foreach from=$widgets item='widget'}
                    <li class="ybc-widget-item">
                        <div class="content_toggle ybc_links_page_home">
                            {if $widget.icon}<i class="fa {$widget.icon|escape:'html':'UTF-8'}"></i>{/if}
                            {if $widget.show_image && $widget.image}<img
                                src="{$widget_module_path|escape:'html':'UTF-8'}images/widget/{$widget.image|escape:'html':'UTF-8'}" alt="{$widget.title|escape:'html':'UTF-8'}" />{/if}
                            {if $widget.show_description && $widget.description}
                                <div class="ybc-widget-description">{$widget.description nofilter}</div>{/if}
                            {if $widget.show_title && $widget.title}<h4 class="ybc-widget-title">{if $widget.link}<a
                                        href="{$widget.link|escape:'html':'UTF-8'}">{/if}{$widget.title|escape:'html':'UTF-8'}{if $widget.link}</a>{/if}</h4>{/if}
    ...
    {elseif $widget_hook == "footer-showroom"}
        <h3 class="h3 title-footer-block hidden-sm-down">{l s='Showrooms system' d='Modules.widgets.Shop'}</h3>
        <div class="title clearfix hidden-md-up" data-target="#footer_show_room" data-toggle="collapse">
            <span class="h3">{l s='Showrooms system' d='Modules.widgets.Shop'}</span>
        ...
        <div class="row">
        <ul class="ybc-widget-ybc-{$widget_hook|escape:'html':'UTF-8'}" id="footer_show_room">
                ...
                {foreach from=$widgets item='widget'}
                    <div class="ybc-widget-item{if isset($tc_config.YBC_TC_FLOAT_CSS3) && $tc_config.YBC_TC_FLOAT_CSS3 == 1} wow zoomIn{/if}">
                        <div class="ybc-widget-item-content ">
                            ...
                            {/if}
                            <div class="wd-content-{$widget_hook|escape:'html':'UTF-8'}">
                                {if $widget.subtitle}
                                    <span class="sub_title main-bg4">{$widget.subtitle|escape:'html':'UTF-8'}</span>
                                {/if}
                                {if $widget.show_image && $widget.image}
                                    <img src="{$widget_module_path|escape:'html':'UTF-8'}images/widget/{$widget.image|escape:'html':'UTF-8'}"
                                         alt="{$widget.title|escape:'html':'UTF-8'}"/>
                                ...
                                <div class="des_content">
                                    ...
                                    {if $widget.link}
                                        <a class="bt_purcha"
                                           href="{$widget.link|escape:'html':'UTF-8'}">{l s='Purchase Now' d='Shop.Theme.Actions'}</a>
                                    {/if}
                                </div>
    ...
    {elseif $widget_hook == "display-footer"}
        <div class="col-md-3">
            <ul class="ybc-widget-{$widget_hook|escape:'html':'UTF-8'}">
                {foreach from=$widgets item='widget'}
                    <li class="ybc-widget-item-{$widget_hook|escape:'html':'UTF-8'} ybc-widget-item{if isset($tc_config.YBC_TC_FLOAT_CSS3) && $tc_config.YBC_TC_FLOAT_CSS3 == 1} wow zoomIn{/if}">
                        <div class="ybc-widget-item-content">
                            {if $widget.icon}<i class="fa {$widget.icon|escape:'html':'UTF-8'}"></i>{/if}
                                ...
                                <div class="ybc-widget-description-content">
                                    ...
                                    {if $widget.show_title && $widget.title}
                                        <h3 class="h3 title-footer-block hidden-sm-down">
                                            {if $widget.link}<a href="{$widget.link|escape:'html':'UTF-8'}">
                                                {/if}<span>{$widget.title|escape:'html':'UTF-8'}</span>{if $widget.link}</a>
                                            {/if}
                                        </h3>
                                        <div class="title clearfix hidden-md-up" data-target="#footer_company" data-toggle="collapse">
                                            <span class="h3">{$widget.title|escape:'html':'UTF-8'}</span>
                                            <span class="pull-xs-right">
                                                <span class="navbar-toggler collapse-icons">
                                                    <i class="material-icons add">expand_more</i>
                                                    <i class="material-icons remove">expand_less</i>
