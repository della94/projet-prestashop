                                                ...
                                                <form action="{$blogCommentAction|escape:'html':'UTF-8'}" method="post">
                                                    {if !$hasLoggedIn}
                                                        <div class="blog-comment-row blog-name">
                                                            <label for="bc-name_customer">{l s='Name' mod='ybc_blog_free'}</label>
                                                            <input class="form-control" name="name_customer" id="bc-name_customer" type="text" value="{if isset($name_customer)}{$name_customer|escape:'html':'UTF-8'}{/if}" />
                                                        </div>
                                                        <div class="blog-comment-row blog-email-comment">
                                                            <label for="bc-email_customer">{l s='Email ' mod='ybc_blog_free'}</label>
                                                            <input class="form-control" name="email_customer" id="bc-email_customer" type="text" value="{if isset($email_customer)}{$email_customer|escape:'html':'UTF-8'}{/if}" />
                                                        </div>
                                                    {/if}
