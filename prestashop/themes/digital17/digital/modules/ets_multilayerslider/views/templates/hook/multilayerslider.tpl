...
{elseif isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT == 'LayoutHome6')}
<div class="box_slider6">
{elseif isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT == 'LayoutHome3')}
<div class="box_slider3">
{/if}
<div class="ets_multilayerslider {if isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT == 'LayoutHome6')} home6{/if} {if isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT == 'LayoutHome1' || $tc_config.YBC_TC_LAYOUT == 'LayoutHome2')} home12{/if} {if $mls_configs.ETS_MLS_SLIDER_TYPE=='full'}hidden{/if}">
    <div class="mls_slides">
    <div data-max-slide-time="{$mls_max_slide_time|intval}" class="mls_slider {if $mls_configs.ETS_MLS_ENABLE_LOADING_ICON}loading{/if} {if isset($mls_configs.ETS_MLS_SLIDER_TYPE)}mls_slider_type_{strtolower($mls_configs.ETS_MLS_SLIDER_TYPE)|escape:'html':'UTF-8'}{/if} mls_layout_{$mls_layout|escape:'html':'UTF-8'}" style="
    {if isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT == 'LayoutHome1' || $tc_config.YBC_TC_LAYOUT == 'LayoutHome2')}width: {$mls_width|intval}px; height: {$mls_height|intval}px;
    {elseif isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT == 'LayoutHome5')} width: 863px; height: 486px;
    {elseif isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT == 'LayoutHome6')} width: 650px; height: 500px;
    {elseif isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT == 'LayoutHome3')} width: 890px; height: 500px;
     {else} width: 1170px; height: 500px;{/if} {if $mls_configs.ETS_MLS_SLIDER_BACKGROUND}background-color: {$mls_configs.ETS_MLS_SLIDER_BACKGROUND|escape:'html':'UTF-8'};{/if}" {hook h='displayMLSConfigs'}>
...
{/if}
{if isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT == 'LayoutHome5')}
    <div class="box_widget5"> {hook h='displayTopColumn'}</div>
    {elseif isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT == 'LayoutHome6')}
    <div class="box_widget6"> {hook h='displayTopColumn'}</div>
{/if}
