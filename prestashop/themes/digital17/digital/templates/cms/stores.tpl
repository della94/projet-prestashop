                ...
                <div class="store-item-container clearfix">
                    {if $store.image}
                        <div class="col-md-3 store-picture hidden-sm-down">
                            <img src="{$store.image.bySize.stores_default.url|escape:'html':'UTF-8'}" alt="{$store.image.legend|escape:'html':'UTF-8'}"
                                 title="{$store.image.legend|escape:'html':'UTF-8'}">
                        </div>
                    {/if}
                    <div class="col-md-5 col-sm-7 col-xs-12 store-description">
                        ...
                        {if $store.note || $store.phone || $store.fax || $store.email}
                            <a data-toggle="collapse" href="#about-{$store.id|escape:'html':'UTF-8'}" aria-expanded="false"
                               aria-controls="about-{$store.id|escape:'html':'UTF-8'}"><strong>{l s='About and Contact' d='Shop.Theme.Actions'}</strong><i
