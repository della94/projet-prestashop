    ...
    <div class="images-container images-container-vertical-right">
        ...
        {block name='product_cover'}
            <div class="product-cover{if (isset($tc_config.YBC_TC_JQZOOM) && $tc_config.YBC_TC_JQZOOM == 1)} product-cover-zoom{/if}">
                <img class="js-qv-product-cover" src="{$product.cover.bySize.large_default.url|escape:'html':'UTF-8'}"
                     alt="{$product.cover.legend|escape:'html':'UTF-8'}" title="{$product.cover.legend|escape:'html':'UTF-8'}" style="width:100%;" itemprop="image">
